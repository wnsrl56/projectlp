...
@Controller
@RequestMapping(value="/mqboard/")
public class mQuestBoardController {
	
	private static final Logger logger = LoggerFactory.getLogger(mQuestBoardController.class);
...
/*	    QPicture qpicture = questService.selectQPicture();
	...
	@RequestMapping(value="insertQuest.action", method = RequestMethod.POST)
	@ResponseBody
		public String QuestInsertGet(@RequestBody Quest quest) {
